 ...
 *
 * Hero 카피 · 특징 4블록 · 언어별 안내 카드(영어/중국어/일본어) · 공통 4단계 흐름 ·
 ...
 *   특정 연령(초등/성인/시니어 등)을 나열하지 않고 "누구나 / 이런 분 / 목표만 있으면" 으로 표현한다(방문자 공감·설명은 주어 생략도 가능).
...
export const powerWhyFeatures = [
  ...
  },
  {
    icon: "📘",
    title: "수준에 맞춘 온라인 교재",
    desc: "기초부터 고급까지, 지금 수준과 목표에 맞춰 수업을 설계합니다.",
  },
  {
    icon: "🔁",
    title: "복습까지 한 번에",
