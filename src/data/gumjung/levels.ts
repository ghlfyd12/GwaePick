...
export const GUMJUNG_LEVELS: GumjungLevel[] = [
  {
    ...
    metaDescription:
      "고졸 검정고시(고등학교 검정고시) 과목 구성·합격 기준·응시 자격·시험 일정과 과목별 공부법을 정리했습니다. 성인 준비도 안내하며, 1:1 맞춤 준비는 무료 상담으로 시작합니다.",
  },
  {
    slug: "jungjol",
    name: "중졸",
    ...
    metaDescription:
      "중졸 검정고시(중학교 검정고시) 과목 구성·합격 기준·응시 자격·시험 일정과 과목별 공부법을 정리했습니다. 고등학교 진학(고입) 준비까지, 1:1 맞춤 준비는 무료 상담으로 시작합니다.",
  },
  {
    slug: "chojol",
    name: "초졸",
    ...
    metaDescription:
      "초졸 검정고시(초등검정고시) 과목 구성·합격 기준·응시 자격·시험 일정과 과목별 공부법을 정리했습니다. 성인·만학도 준비까지, 1:1 맞춤 준비는 무료 상담으로 시작합니다.",
  },
];
