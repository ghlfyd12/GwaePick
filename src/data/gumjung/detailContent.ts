...
export const GUMJUNG_LEVEL_FAQ_EXTRA: { q: string; a: string }[] = [
  ...
  {
    q: "검정고시 과외 비용은 어떻게 되나요?",
    a: "준비 과목 수와 현재 수준, 방문·화상 등 수업 방식에 따라 달라집니다. 목표에 맞는 공부 방법과 함께 상담에서 안내해 드립니다.",
  },
  {
    q: "검정고시는 몇 살부터 볼 수 있나요?",
    a: "초졸 검정고시는 만 11세 이상이면 응시할 수 있고, 중졸·고졸 검정고시는 응시 나이 제한이 없습니다. 다만 고졸은 학교에서 제적된 날로부터 공고일 기준 6개월이 지나야 응시할 수 있습니다(등록 장애인은 예외).",
  },
];
