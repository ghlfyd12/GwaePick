...
export type GumjungGuide = {
  ...
  /** 유형별 전용 FAQ 1문항(공통 2문항 외 추가). 없으면 공통 2문항만. */
...
export const GUMJUNG_GUIDES: GumjungGuide[] = [
  {
    ...
    metaTitle: "검정고시 빠른 대입 준비 - 과목 집중 1:1 개인과외 공부법",
    metaDescription:
  ...
  },
  {
    ...
    metaTitle: "예체능 검정고시 - 실기 병행 1:1 개인과외 준비",
    metaDescription:
  ...
  },
  {
    ...
    metaTitle: "학업 공백 검정고시 - 기초부터 1:1 개인과외 준비",
    metaDescription:
  ...
  },
  {
    ...
    metaTitle: "성인 검정고시 - 만학도 직장인 고졸 1:1 개인과외 준비",
    metaDescription:
    ...
    sections: [
      {
        heading: "일정에 맞춘 수업",
        body: "화상 수업으로 오가는 시간을 줄이고, 필요한 과목부터 준비합니다. 상담에서 가능한 시간대와 목표 시기를 확인해 계획을 함께 정합니다.",
      },
    ],
    related: [
      { label: "고졸 검정고시 안내", href: "/gumjung/gojol" },
  ...
  },
  {
    ...
    metaTitle: "검정고시 고입 - 중졸 검정고시 고등학교 진학 1:1 과외",
    metaDescription:
    ...
    faqExtra: {
      q: "중졸 검정고시로 고등학교에 갈 수 있나요?",
      a: "중졸 검정고시 합격은 고등학교 입학 자격이 됩니다. 진학 방법·일정은 학교 유형과 지역에 따라 다르므로 상담에서 확인합니다.",
    },
    related: [
      { label: "중졸 검정고시 안내", href: "/gumjung/jungjol" },
      { label: "대입 전략 가이드", href: "/gumjung/guide/daeip-strategy" },
  ...
  },
  {
    ...
    metaTitle: "국제학교 검정고시 - 국내 학력 인정 1:1 개인과외 준비",
    metaDescription:
    ...
    faqExtra: {
      q: "국제학교를 다녀도 검정고시를 볼 수 있나요?",
      a: "재학 형태에 따라 다릅니다. 국내 학력 인정 경로로 검정고시를 준비하는 경우가 있으며, 필요한 자격은 상담에서 확인합니다.",
    },
    related: [
      { label: "고졸 검정고시 안내", href: "/gumjung/gojol" },
  ...
  },
  {
    ...
    metaTitle: "대입전략 검정고시 검고 - 합격 후 수능 대입 일정 1:1 과외",
    metaDescription:
      "검정고시 대학 진학을 목표로 한다면, 검정고시(검고) 합격 후 대입까지 일정을 함께 설계합니다. 검정고시 성적의 대입 활용은 전형에 따라 다르므로 상담에서 확인이 필요합니다.",
    ...
    faqExtra: {
      q: "검정고시 성적이 대입에 어떻게 쓰이나요?",
      a: "전형에 따라 활용 방식이 다릅니다. 정확한 내용은 상담에서 확인하고, 검정고시 일정과 이후 입시 일정을 함께 설계합니다.",
    },
    related: [
      { label: "빠른 대입 준비 가이드", href: "/gumjung/guide/fast-daeip" },
      { label: "고졸 검정고시 안내", href: "/gumjung/gojol" },
